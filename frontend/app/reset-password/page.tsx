      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-green-50 rounded-3xl flex items-center justify-center mx-auto mb-6 rotate-3 hover:rotate-0 transition-transform duration-300 shadow-sm">
              <svg className="w-10 h-10 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
              </svg>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-gray-900 mb-2">Reset Password</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5 ml-1">At least 6 characters</p>
            </div>
            ...
            <div>
              ...
              {formData.confirmPassword && (
                <p className={`text-xs mt-1.5 ml-1 flex items-center ${formData.newPassword === formData.confirmPassword ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/login"
              className="text-gray-600 hover:text-gray-900 font-medium inline-flex items-center gap-2 transition"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
